    ...
    <div className="sticky lg:static top-0 navbar bg-base-100 min-h-16 shrink-0 justify-between z-20 border-b-2 border-base-300 p-0 sm:px-2">
      <div className="navbar-start w-auto self-stretch">
        ...
        <Link href="/" passHref className="hidden lg:flex items-center gap-2 ml-4 mr-6 shrink-0">
          <span className="flex size-10 items-center justify-center rounded-xl bg-primary text-sm font-black text-primary-content">
            PHT
          </span>
          <div className="flex flex-col">
            <span className="font-bold leading-tight">PHT Exchange</span>
            <span className="text-xs">Avalanche Fuji</span>
          </div>
        </Link>
